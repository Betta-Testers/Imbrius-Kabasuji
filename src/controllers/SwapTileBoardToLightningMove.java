...
public class SwapTileBoardToLightningMove extends Move {
	Board board;
	BoardTile oldTile;
	LightningTile newTile;
	
	public SwapTileBoardToLightningMove (BuilderView bView, BoardTile old, AbstractLevelModel lm) {
	...
	public boolean doMove() {
		if(isValid()) {
			this.newTile = new LightningTile(oldTile.getRow(), oldTile.getCol());
