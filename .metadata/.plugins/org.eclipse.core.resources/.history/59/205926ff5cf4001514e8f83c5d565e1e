...
public class Release extends JFrame {
	...
	public Release() {
		...
		lblLevel.setLabelFor(contentPane);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(gameBoard, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
						.addComponent(bullpen, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 508, Short.MAX_VALUE)
						.addComponent(btnHint, Alignment.TRAILING))
					.addGap(52))
		);
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(bullpen, GroupLayout.PREFERRED_SIZE, 103, GroupLayout.PREFERRED_SIZE)
		...
		lblBoardImage.setLabelFor(gameBoard);
		...
		JLabel lblNumerSets = new JLabel("Numer Sets");
		lblNumerSets.setFont(new Font("Tahoma", Font.BOLD, 11));
		...
		lblRed.setLabelFor(progressBar);
		lblRed.setFont(new Font("Tahoma", Font.PLAIN, 11));
		
		JLabel lblBlue = new JLabel("Blue");
		lblBlue.setLabelFor(progressBar_1);
				...
				.addGroup(gl_gameBoard.createSequentialGroup()
					...
					.addGroup(gl_gameBoard.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_gameBoard.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_gameBoard.createParallelGroup(Alignment.LEADING)
								.addComponent(progressBar_1, GroupLayout.PREFERRED_SIZE, 75, GroupLayout.PREFERRED_SIZE)
								.addComponent(progressBar, GroupLayout.PREFERRED_SIZE, 75, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_gameBoard.createSequentialGroup()
							.addGap(18)
							.addComponent(lblNumerSets))
						.addGroup(gl_gameBoard.createSequentialGroup()
							.addGap(37)
							.addComponent(lblRed))
						.addGroup(gl_gameBoard.createSequentialGroup()
